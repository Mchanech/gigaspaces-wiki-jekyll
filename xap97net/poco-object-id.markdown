...
# How is a Space Object ID Generated?
...
The space UID for a space object can be created in three different ways:
...
{% note %} The compound ID class must implement a `ToString` method that returns a unique String for each ID. {%endnote%}
